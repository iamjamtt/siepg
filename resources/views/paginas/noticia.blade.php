            ...
            <div class="row justify-content-center">
                <div class="col-xl-9">
                    <div class="th-blog blog-single">
                        <div class="blog-img">
                            <img src="{{ $noticia['imagen'] }}" alt="{{ $noticia['slug'] }}">
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a href="javascript:void(0)"><i class="far fa-user"></i>Autor</a>
                                <a href="javascript:void(0)"><i class="far fa-clock"></i>{{ $noticia['fecha'] }}</a>
                            </div>
                            <p class="fs-18">
                                {!! \Illuminate\Support\Str::markdown($noticia['descripcion_md']) !!}
                            </p>
                                ...
                                <div class="row justify-content-between">
                                    <div class="col-md-auto">
                                        ...
                                        <div class="tagcloud">
                                            ...
                                            <a href="javascript:void(0)">Tecnología</a>
                                            <a href="javascript:void(0)">Innovación</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
